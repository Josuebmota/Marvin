...
> 
> Estado corrente e próximo passo: `.marvin/08_Memoria/onde_paramos.md`.

## Onde parou

`/retomar` num chat novo — lê `.marvin/08_Memoria/onde_paramos.md` e confere contra o `git log`
...
`.marvin/08_Memoria/`. O Claude escreve no caminho padrão e os arquivos nascem no repositório.
...
nada chega ao repositório. As notas antigas continuam em `.marvin/08_Memoria/`; quebrou só o
